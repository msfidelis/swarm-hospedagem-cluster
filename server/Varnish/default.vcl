...
#Chama quando o VCL é carregado. Todos os requests passam por aqui antes de qualquer coisa
sub vcl_init {
...
sub vcl_recv {
  ...
  # Somente cachear requests GET - Não implementado pela força do cagaço 
